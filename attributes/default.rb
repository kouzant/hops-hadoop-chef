...
default['hops']['versions']                    = "2.8.2.2,2.8.2.3,2.8.2.4,2.8.2.5,2.8.2.6,2.8.2.7,2.8.2.8,2.8.2.9,2.8.2.10,3.2.0.0,3.2.0.1,3.2.0.2,3.2.0.3,3.2.0.4,3.2.0.5,3.2.0.6,3.2.0.7,3.2.0.8"
default['hops']['version']                     = "3.2.0.9-SNAPSHOT"
default['hops']['fuse']['version']             = "3.2.0.9"
...
default['hops']['hdfs']['max-directory-items'] = "131072"
...
default['hops']['docker_version']['ubuntu']           = "20.10.7"
